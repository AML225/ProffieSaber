...
Preset blade[] = {								//When Emitter is Attached (Yes Blade, No CC)
  ...
  { "Survivor", "tracks/JFO/JFO1.wav",
	StylePtr<InOutHelper<OnSpark<Stab<LocalizedClash<Lockup<Blast<AudioFlicker<Gradient<Gradient<LightCyan,Cyan,Cyan>,Cyan,Cyan,Cyan,Cyan,Cyan,Cyan,Cyan>,Aqua>,BrownNoiseFlicker<Red,Magenta,300>,150,200,600>,Pulsing<Gradient<AudioFlicker<LightCyan,Cyan>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,300>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,300>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>>,Gradient<AudioFlicker<LightCyan,Cyan>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,300>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,300>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>>,3500>,Gradient<AudioFlicker<Cyan,Aqua>,AudioFlicker<Cyan,Aqua>,AudioFlicker<Cyan,Aqua>,Gradient<AudioFlicker<Cyan,Aqua>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,300>,White>>>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,50>,100,50>,Gradient<AudioFlicker<Cyan,Aqua>,AudioFlicker<Cyan,Aqua>,AudioFlicker<Cyan,Aqua>,Gradient<AudioFlicker<Cyan,Aqua>,BrownNoiseFlicker<White,Strobe<Red,LemonChiffon,50,1>,300>,White>>,1400>,White,200>,200,300,Black>>(), //SCW PCB NPXLs
	StylePtr<InOutHelper<OnSpark<Stab<LocalizedClash<Lockup<Blast<AudioFlicker<Gradient<Gradient<LightCyan,Cyan,Cyan>,Cyan,Cyan,Cyan,Cyan,Cyan,Cyan,Cyan>,Aqua>,BrownNoiseFlicker<Red,Magenta,300>,150,200,600>,Pulsing<Gradient<AudioFlicker<LightCyan,Cyan>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,300>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,300>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>>,Gradient<AudioFlicker<LightCyan,Cyan>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,300>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,300>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>,HumpFlicker<Cyan,Aqua,50>>,3500>,Gradient<AudioFlicker<Cyan,Aqua>,AudioFlicker<Cyan,Aqua>,AudioFlicker<Cyan,Aqua>,Gradient<AudioFlicker<Cyan,Aqua>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,300>,White>>>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,50>,100,50>,Gradient<AudioFlicker<Cyan,Aqua>,AudioFlicker<Cyan,Aqua>,AudioFlicker<Cyan,Aqua>,Gradient<AudioFlicker<Cyan,Aqua>,BrownNoiseFlicker<White,Strobe<Red,LemonChiffon,50,1>,300>,White>>,1400>,White,200>,200,300,Black>>(), //KR Pixel Stick 
	StyleNormalPtr<BLACK, BLACK, 300, 800>(),				//Crystal Chamber
	StylePtr<InOutHelper<Pulsing<WHITE, BLACK, 800>, 300, 800, WHITE>>(),	//Red Control Box LED
	StylePtr<InOutHelper<WHITE, 300, 800, Pulsing<WHITE, BLACK, 800>>>(),	//Green Control Box LED
	StylePtr<Blue>(),	//Bluetooth
  ...
  { "Kylo 1", "Kylo1/tracks/KyloTheme.wav", //Fett263 "Film-Based" Kylo Ren Unstable Neopixel Lightsaber (Static) Styles
